...
class InputContraRegistro extends StatefulWidget {
  String label;
  String inputHint;
  InputContraRegistro({this.label, this.inputHint});

  @override
  _InputContraRegistro createState() => _InputContraRegistro();
}

class _InputContraRegistro extends State<InputContraRegistro> {
  @override
  Widget build(BuildContext context) {
    return Column(
       children: [
